      ...
      <div className="relative bg-[#f3f7f9] py-16 px-12 rounded-2xl shadow-lg max-w-sm w-full">
        <div className="flex flex-col items-center gap-4">
          ...
          <button className="bg-primary-red text-white rounded-2xl py-2 px-4 w-full  flex items-center justify-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="17"  viewBox="0 0 30 30">
            <path fill="white"  d="M 15.003906 3 C 8.3749062 3 3 8.373 3 15 C 3 21.627 8.3749062 27 15.003906 27 C 25.013906 27 27.269078 17.707 26.330078 13 L 25 13 L 22.732422 13 L 15 13 L 15 17 L 22.738281 17 C 21.848702 20.448251 18.725955 23 15 23 C 10.582 23 7 19.418 7 15 C 7 10.582 10.582 7 15 7 C 17.009 7 18.839141 7.74575 20.244141 8.96875 L 23.085938 6.1289062 C 20.951937 4.1849063 18.116906 3 15.003906 3 z"></path>
          </svg>
